...
import 'package:social_book/app/modules/profileOtherUser/controllers/profile_other_user_controller.dart';

class ProfileOtherUserView extends GetView<ProfileOtherUserController> {
  const ProfileOtherUserView({super.key});

  @override
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    return GetBuilder<ProfileOtherUserController>(
      init: ProfileOtherUserController(),
      builder: (controller) {
        return Obx(() {
          final userProfile = controller.otherUserProfileModel.value?.data;
