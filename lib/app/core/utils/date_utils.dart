...
class AppDateUtils {
  ...
  //   final DateTime createdAt = DateTime.parse(isoDate);
  ...
  //   // 🔹 Month + Year (older)
  //   return AppDateUtils.extractDate(createdAt.toString(), 14);
  // }
  static String? timeAgo(String isoDate) {
    if (isoDate.isEmpty) {
      return null;
    }
    // Convert UTC ISO date to Indian local time
    final DateTime createdAt = DateTime.parse(isoDate);
    ...
    // Older than a month
    return AppDateUtils.extractDate(createdAt.toIso8601String(), 14);
  }
}
